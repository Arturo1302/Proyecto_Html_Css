...
Este es un proyecto web para gestionar indicadores de proyectos. Básicamente es un panel donde puedes ver, añadir y eliminar indicadores con toda su info: fechas, categorías, progreso, etc.
